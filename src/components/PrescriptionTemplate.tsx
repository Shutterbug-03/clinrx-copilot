...
export function PrescriptionTemplate({ data, onClose }: PrescriptionTemplateProps) {
    ...
    const handleDownload = () => {
        // For demo, we'll use print to PDF
        handlePrint();
    };
    ...
    return (
        <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center p-4 overflow-auto">
            <div className="bg-white rounded-xl shadow-xl max-w-4xl w-full max-h-[90vh] overflow-auto">
                ...
                <div className="p-6">
                    <div ref={printRef} className="prescription border-2 border-indigo-800 p-6 bg-white">
                        {/* Header */}
                        <div className="header flex justify-between items-start border-b-2 border-indigo-800 pb-4 mb-4">
                            <div>
                                <h1 className="hospital-name text-2xl font-bold text-indigo-800">{data.hospital.name}</h1>
                        ...
                        {/* Rx Symbol */}
                        <p className="rx-symbol text-3xl font-bold text-indigo-800 my-4">℞</p>
